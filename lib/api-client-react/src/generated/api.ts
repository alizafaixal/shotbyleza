...
export const updateInquiryStatus = async (id: number,
    inquiryStatusInput: InquiryStatusInput, options?: RequestInit): Promise<Inquiry> => {
...
export const getUpdateInquiryStatusMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateInquiryStatus>>, TError,{id: number;data: BodyType<InquiryStatusInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateInquiryStatus>>, TError,{id: number;data: BodyType<InquiryStatusInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateInquiryStatus>>, {id: number;data: BodyType<InquiryStatusInput>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateInquiryStatusMutationBody = BodyType<InquiryStatusInput>
    export type UpdateInquiryStatusMutationError = ErrorType<unknown>

    /**
 * @summary Update inquiry status
 */
export const useUpdateInquiryStatus = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateInquiryStatus>>, TError,{id: number;data: BodyType<InquiryStatusInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateInquiryStatus>>,
        TError,
        {id: number;data: BodyType<InquiryStatusInput>},
        TContext
      > => {
